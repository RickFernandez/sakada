...
const API_ROUTES = {
  ...
  pages: `${API_URL}/pages?populate[pageHeader][populate][backgroundMedia][fields][0]=url&populate[projects][fields][0]=referenceUrl&populate[projects][populate][wallpaperMedia][fields][0]=url&populate[projects][populate][project_filters][fields][0]=name&populate[project_filters][fields][0]=name&filters[urlReference]=digital-projects`,
