...
const API_ROUTES = {
  ...
  pages: `${API_URL}/pages?populate[pageHeader][populate][backgroundMedia][fields][0]=ur&populate[projects][fields][0]=referenceUrl&populate[projects][populate][wallpaperMedia][fields][0]=url&populate[projects][populate][project_filters][fields][0]=name&populate[project_filters][fields][0]=name&populate[team][populate][employee][fields][0]=name&populate[team][populate][employee][fields][1]=description&populate[team][populate][employee][populate][picture][fields][0]=url&populate[clients][populate][client][populate][logo][fields][0]=url`,
